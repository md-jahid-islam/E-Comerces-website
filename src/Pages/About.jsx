 ...
 //===================== AboutSection part start 
     const AboutSection = () => (
     <section className="about-section container mx-auto mt-5 px-4 sm:px-6 md:px-8 lg:px-16">
     {/* Section Title */}
     <div className=" relative text-center sm:text-left pt-28 flex justify-center items-center flex-wrap ">
      <h2 className=" text-2xl font-bold text-[#4f4f4f]">About Me</h2>
      <div className=" absolute border-2 border-[#4f4f4f] w-24 sm:w-32 mx-auto sm:mx-0 pt-10 "></div>
     </div>
     {/* About Details */}
     <div className="mt-8 flex flex-col lg:flex-row justify-between items-start lg:items-center">
      {/* About Text */}
      <div>
      <p className="text-[#4f4f4f] leading-relaxed text-center lg:text-left lg:p-10 max-w-full sm:max-w-xl lg:max-w-3xl">
      ...
      {/* Personal Details */}
      <div className="text-sm sm:text-base mt-10 lg:mt-0 lg:ml-10">
        {[
   ...
   <div className="education-section container px-4 sm:px-6 lg:px-16">
    <h2 className="text-2xl font-bold text-[#4f4f4f] pt-10 text-center sm:text-left ">
    Education
    </h2>
    <div className="divider bg-slate-400 mt-2 mb-4"></div>
     ...
     {[
      {
        year: 'Degree onegoing Student Bachelor of Social Science -2024',
 ...
 //====================== SkillSection part start
     ...
     <div className="flex justify-center items-center relative mb-4">
      <h2 className=" relative text-2xl font-bold text-[#4f4f4f]  text-center sm:text-left">Coding Skills</h2>
      <h3 className="absolute border-2 border-[#4f4f4f] w-[150px] sm:w-[200px]  pt-10 "></h3>
     </div>
